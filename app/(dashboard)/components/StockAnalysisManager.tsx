...
function StockAnalysisManager() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Top Analyst Ideas</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-3">
          <div className="flex space-x-3">
            ...
            >
              ...
              <SelectContent>{/* Add sector options */}</SelectContent>
            </Select>
            <Select
              onValueChange={(value) => handleFilterChange("analyst", value)}
            >
              <SelectTrigger>
                <SelectValue placeholder="Filter by Analyst" />
              </SelectTrigger>
              <SelectContent>{/* Add analyst options */}</SelectContent>
            </Select>
            <Select
            ...
            <TableBody>
              {analyses.map((analysis) => (
                <TableRow key={analysis.id}>
                  <TableCell>{analysis.analysis.split(":")[0]}</TableCell>
